...
# 🔥 IMPORTANT: use OpenEnv instead of plain FastAPI
from openenv.core.env_server.http_server import create_app

from server.cashflowmanager_environment import run_simulation, init_simulation, step_one_day
from models import SimulationResult, DayLog

# ✅ Create OpenEnv app (this enables default UI at `/`)
app = create_app(env_name="cashflowmanager")
...
# (rest of your helper + UI code remains EXACTLY same...)

# ──────────────────────────────────────────────
# Gradio UI Mount (IMPORTANT FIX HERE)
# ──────────────────────────────────────────────
